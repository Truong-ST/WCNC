...
public class Factor {
    ...
    public static double P_MULTIPLIER_1 = 1.5;
    public static double P_MULTIPLIER_2 = 2;
    public static double P_BOUND = 0;
    // Tham so chu ki sac
//    public static double T = 24800;   //s, thoi gian trien khai mang
    public static final double T = 10;  
    public static double t = 15;   //s, thoi gian xet mang
    ...
    public static final int SEEDS = 1; // So luong seed
    public static int SEED = 0; // SEED hien tai
    public static final int N = 200; // So luong ca the trong quan the mac dinh
...
//    For experiment 20/08/2020
    ...
    public static final int E_MC_DEFAULT = 10800;
    public static final int V_DEFAULT = 5;
    public static final int T_DEFAULT = 24800;
...
//    public static final int[] Us = {5, 10, 15, 20, 25};
    public static final int[] Us = {2, 3, 4, 5, 6, 7, 8, 9, 10};
...
//public static final double[] Ps = {1, 1.5};
 public static final double[] Ps = {0.5, 1, 1.5, 2, 2.5, 3};
}
